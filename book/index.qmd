...
deal of repition in plots (like CWRES versus TIME, WRES, versus TIME, 
RES versus TIME). This is by design with the intention to make the reader aware
of the different functions in the package. __One execption__ to this is the 
page on [customization](custom.html). Please take a moment to look through 
